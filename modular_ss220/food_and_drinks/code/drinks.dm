...
/obj/machinery/economy/vending/boozeomat/Initialize(mapload)
	...
	products += list(/obj/item/reagent_containers/drinks/bottle/bitter = 1)
	products += list(/obj/item/reagent_containers/drinks/bottle/bluecuracao = 1)
	products += list(/obj/item/reagent_containers/drinks/bottle/sambuka = 1)
	products += list(/obj/item/reagent_containers/drinks/bottle/jagermeister = 1)
	return ..()
